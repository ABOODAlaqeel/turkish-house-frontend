      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="about-image relative group">
            {/* Asymmetrical gold decorative outline */}
            <div className="absolute -inset-2 border border-accent/20 rounded-2xl pointer-events-none group-hover:rotate-2 group-hover:scale-[1.01] transition-transform duration-500 z-0" />
            
            <div className="relative rounded-2xl overflow-hidden aspect-[4/5] max-w-md mx-auto lg:mx-0 border border-white/5 shadow-2xl z-10">
              {/* Curtain overlay */}
            ...
            <div className="about-floating-badge absolute -bottom-4 -right-4 lg:bottom-8 lg:-right-8 bg-bg-secondary/80 backdrop-blur-md border border-brand/20 rounded-xl p-4 sm:p-5 animate-float-subtle shadow-2xl shadow-brand/35 z-30">
              ...
              <div className="text-text-primary text-xs font-semibold mt-1">سنوات من التميز</div>
            </div>
          </div>
          ...
          <div className="about-content">
            ...
            <div className="about-social-proof flex items-center gap-4 bg-bg-secondary/40 backdrop-blur-sm border border-white/5 rounded-2xl p-4 shadow-lg">
              <div className="flex -space-x-3 space-x-reverse">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full bg-brand/10 border-2 border-bg-primary flex items-center justify-center transition-all hover:scale-110 hover:-translate-y-1 duration-300">
                    <Users size={14} className="text-accent" />
                  </div>
                ))}
              </div>
              <div>
                <div className="text-text-primary font-bold text-sm">+١٠٠٠ زبون راضٍ</div>
                <div className="text-text-secondary text-xs font-medium">يثقون في جودتنا واستثنائية خدماتنا</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="feature-cards-grid grid grid-cols-2 md:grid-cols-4 gap-4">
          {features.map(({ icon: Icon, title, desc }) => (
            <TiltCard key={title}>
              <div className="feature-card bg-bg-secondary/40 backdrop-blur-sm border border-white/5 rounded-2xl p-6 text-center hover:border-brand/30 hover:bg-bg-secondary/60 hover:shadow-[0_15px_35px_rgba(139,36,56,0.15)] transition-all duration-500 group cursor-default h-full relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 mx-auto mb-4 rounded-xl bg-brand/10 border border-brand/20 flex items-center justify-center group-hover:bg-brand/20 group-hover:scale-110 transition-all duration-500 text-accent">
                    <Icon size={22} className="group-hover:rotate-12 transition-transform duration-300" />
                  </div>
                  <h3 className="text-text-primary font-bold text-sm mb-2 group-hover:text-accent transition-colors duration-300">{title}</h3>
